<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DanhSachSanPham.aspx.cs" Inherits="DanhSachSanPham" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="panel-heading" style="text-align:center; font-size:18px">SẢN PHẨM</div>
    

    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy" TypeName="DataSetTableAdapters.SanPhamDMTableAdapter" UpdateMethod="Update">
        <DeleteParameters>
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="ID_Nhom" QueryStringField="ID" Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="TenSP" Type="String" />
            <asp:Parameter Name="HinhAnh" Type="String" />
            ...
            <div class="col-md-4 home-grid" style="width:237px; height:350px; margin-top:15px; margin-bottom:30px; margin-left:5px">
						...
						<div class="home-product-main">
							    ...
							    <div class="home-product-bottom">
								    ...
								    <h4 style="text-align:center;"><a  href="Giohang.aspx">THÊM VÀO GIỎ</a></h4> 
								    <p> </p >      
							    </div>
                            </div>
